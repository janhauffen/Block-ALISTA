...
for k in range(0, len(SNR_list)):
    ...
    sess = train.do_training(training_stages,prob,'trainings/small_normalized_D_LBISTA_CPSS_block_Gauss_giidT'+str(T)+'Thermo6-JanWithSNR_dB'+str(SNR)+'batch'+str(MC)+'.npz')
    """# Evaluating"""
